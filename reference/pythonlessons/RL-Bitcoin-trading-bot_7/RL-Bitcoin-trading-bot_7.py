...
if __name__ == "__main__":            
    ...
    df = pd.read_csv("./NYSE:BABA_10min.csv")
    df = df.dropna()
    ...
    agent = CustomAgent(lookback_window_size=lookback_window_size, lr=0.00001, epochs=5, optimizer=Adam, depth=depth, batch_size = 32, model="CNN")
    ...
    #test_multiprocessing(CustomEnv, CustomAgent, train_df, train_df_nomalized, num_worker = 16, visualize=False, test_episodes=1000, folder="2021_02_21_17_54_Crypto_trader", name="3447.20_Crypto_trader", comment="3 months")
